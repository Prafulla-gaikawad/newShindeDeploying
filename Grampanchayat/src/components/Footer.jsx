const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white py-16 border-t border-gray-700">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                ...
                >
                  <div className="w-10 h-10 bg-teal-500/20 rounded-lg flex items-center justify-center group-hover:bg-teal-500/30 transition-all">
              ...
              <li className="text-gray-300 flex items-start gap-3">
                ...
                <span className="leading-relaxed">At/Post-शिंदे खु तालुका-चांदवड जिल्हा-नाशिक</span>
              </li>
              <li className="flex gap-3 mt-6">
                <a href="#" className="w-10 h-10 bg-teal-500/20 hover:bg-teal-500 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110" aria-label="Facebook">
                ...
                <a href="#" className="w-10 h-10 bg-teal-500/20 hover:bg-teal-500 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110" aria-label="Instagram">
                  <svg className="w-5 h-5 text-teal-400" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#" className="w-10 h-10 bg-teal-500/20 hover:bg-teal-500 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110" aria-label="Youtube">
                  <svg className="w-5 h-5 text-teal-400" fill="currentColor" viewBox="0 0 24 24">
